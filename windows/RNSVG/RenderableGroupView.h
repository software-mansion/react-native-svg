...
#include "RenderableGroupView.g.h"
#include "SVGLength.h"

namespace winrt::RNSVG::implementation {
struct RenderableGroupView : RenderableGroupViewT<RenderableGroupView> {
 public:
  RenderableGroupView() = default;
  ...
  Windows::Foundation::Collections::IVector<IRenderable> Children() { return m_children; }
  void AddChild(IRenderable const &child);
 ...
 private:
  ...
  Windows::Foundation::Collections::IVector<IRenderable> m_children{winrt::single_threaded_vector<IRenderable>()};
