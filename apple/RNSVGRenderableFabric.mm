...
@implementation RNSVGRenderableFabric
{
...
static RNSVGRenderableFabric * _contextElement;
+ (RNSVGRenderableFabric *)contextElement { return _contextElement; }
+ (void)setContextElement:(RNSVGRenderableFabric *)contextElement { _contextElement = contextElement; }
...
- (RNSVGPlatformView *)hitTest:(CGPoint)point withEvent:(UIEvent *)event
{
    ...
    if (self.clipPath) {
        ...
        if ([clipNode isSimpleClipPath]) {
            ...
            RNSVGRenderableFabric *clipGroup = (RNSVGRenderableFabric*)clipNode;
...
- (void)mergeProperties:(__kindof RNSVGRenderableFabric *)target
{
