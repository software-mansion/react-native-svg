...
RCT_ENUM_CONVERTER(
    RNSVGComponentTransferFuncChannel,
    (@{
      @"UNKNOWN" : @(SVG_FECOMPONENTTRANSFERFUNC_CHANNEL_UNKNOWN),
      @"R" : @(SVG_FECOMPONENTTRANSFERFUNC_CHANNEL_R),
      @"G" : @(SVG_FECOMPONENTTRANSFERFUNC_CHANNEL_G),
      @"B" : @(SVG_FECOMPONENTTRANSFERFUNC_CHANNEL_B),
      @"A" : @(SVG_FECOMPONENTTRANSFERFUNC_CHANNEL_A),
    }),
    SVG_FECOMPONENTTRANSFERFUNC_CHANNEL_UNKNOWN,
    intValue)

RCT_ENUM_CONVERTER(
    RNSVGComponentTransferFuncType,
    (@{
      @"identity" : @(SVG_FECOMPONENTTRANSFERFUNC_TYPE_IDENTITY),
      @"table" : @(SVG_FECOMPONENTTRANSFERFUNC_TYPE_TABLE),
      @"discrete" : @(SVG_FECOMPONENTTRANSFERFUNC_TYPE_DISCRETE),
      @"linear" : @(SVG_FECOMPONENTTRANSFERFUNC_TYPE_LINEAR),
      @"gamma" : @(SVG_FECOMPONENTTRANSFERFUNC_TYPE_GAMMA),
    }),
