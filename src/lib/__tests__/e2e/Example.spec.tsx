...
test('rendered line difference should be less than 2%', async () => {
    ...
    const pixelDiff = pixelmatch(referencePng.data, responsePng.data, diffPng.data, height * 3, width * 3, {
        diffColor: [95, 0, 160]
    })

    fs.writeFileSync(`e2e/diffs/${expect.getState().currentTestName}-diff.png`, PNG.sync.write(diffPng))
