...
export interface TransformProps {
  /**
   * @deprecated Use translate in transform prop instead.
   */
  ...
  /**
   * @deprecated Use transformOrigin in transform prop instead.
   */
  origin?: NumberArray;
  /**
   * @deprecated Use transformOrigin in transform prop instead.
  ...
  originX?: NumberProp;
  /**
   * @deprecated Use transformOrigin prop instead.
   */
  originY?: NumberProp;
  /**
   * @deprecated Use scale in transform prop instead.
   */
  scale?: NumberArray;
  /**
  ...
  scaleY?: NumberProp;
  /**
   * @deprecated Use skew in transform prop instead.
   */
  skew?: NumberArray;
  /**
