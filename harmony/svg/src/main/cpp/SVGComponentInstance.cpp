#include "SVGComponentInstance.h"
#include "Props.h"
...
SVGComponentInstance::SVGComponentInstance(Context context)
    : CppComponentInstance(std::move(context)) {
    

}

void SVGComponentInstance::onPropsChanged(SharedConcreteProps const &props) {
//     CppComponentInstance::onPropsChanged(props);
    LOG(INFO) << "[SVGComponentInstance] ";
...
SVGArkUINode &SVGComponentInstance::getLocalRootArkUINode() { return m_svgArkUINode; }
