...
class RenderableViewManager<T extends RenderableView> extends VirtualViewManager<T> {
  ...
  static class FeMergeManager extends VirtualViewManager<FeMergeView>
    ...
    @ReactProp(name = "x")
    public void setX(FeMergeView node, Dynamic x) {
      node.setX(x);
    }

    @ReactProp(name = "y")
    public void setY(FeMergeView node, Dynamic y) {
      node.setY(y);
    }

    @ReactProp(name = "width")
    public void setWidth(FeMergeView node, Dynamic width) {
      node.setWidth(width);
    }

    @ReactProp(name = "height")
    public void setHeight(FeMergeView node, Dynamic height) {
      node.setHeight(height);
    }

    @ReactProp(name = "result")
    public void setResult(FeMergeView node, String result) {
      node.setResult(result);
    }
