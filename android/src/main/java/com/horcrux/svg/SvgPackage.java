...
public class SvgPackage extends BaseReactPackage implements ViewManagerOnDemandReactPackage {
  ...
  private Map<String, ModuleSpec> getViewManagersMap(final ReactApplicationContext reactContext) {
    if (mViewManagers == null) {
      ...
      specs.put(
          FeComponentTransferManager.REACT_CLASS,
          ModuleSpec.viewManagerSpec(
              new Provider<NativeModule>() {
                @Override
                public NativeModule get() {
                  return new FeComponentTransferManager();
                }
              }));
      specs.put(
          FeComponentTransferFunctionManager.REACT_CLASS,
          ModuleSpec.viewManagerSpec(
              new Provider<NativeModule>() {
                @Override
                public NativeModule get() {
                  return new FeComponentTransferFunctionManager();
                }
              }));
      specs.put(
