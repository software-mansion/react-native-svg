...
public class RNSVGFeComponentTransferManagerDelegate<T extends View, U extends BaseViewManager<T, ? extends LayoutShadowNode> & RNSVGFeComponentTransferManagerInterface<T>> extends BaseViewManagerDelegate<T, U> {
  public RNSVGFeComponentTransferManagerDelegate(U viewManager) {
    super(viewManager);
  }
  @Override
