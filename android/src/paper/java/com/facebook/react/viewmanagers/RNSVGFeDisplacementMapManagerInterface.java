...
public interface RNSVGFeDisplacementMapManagerInterface<T extends View> {
  ...
  void setXChannelSelector(T view, @Nullable String value);
  void setYChannelSelector(T view, @Nullable String value);
}
