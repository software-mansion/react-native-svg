...
public class RNSVGFeTileManagerDelegate<T extends View, U extends BaseViewManager<T, ? extends LayoutShadowNode> & RNSVGFeTileManagerInterface<T>> extends BaseViewManagerDelegate<T, U> {
  public RNSVGFeTileManagerDelegate(U viewManager) {
    super(viewManager);
  }
  @Override
