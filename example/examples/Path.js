    ...
    <Page title="Path">
      <Example title="Path">
        <Svg height="100" width="100">
          <Path fill="black" d="M50 0 L15 100 L85 100 Z" />
          <Path
            fill="red"
      ...
      <Example title="The following example creates a quadratic Bézier curve, where A and C are the start and end points, B is the control point">
